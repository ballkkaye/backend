...
public class HomeControllerTest extends MyRestDoc {
    ...
    void get_home_test() throws Exception {
        ...
        actions.andExpect(MockMvcResultMatchers.status().isOk())
                ...
                .andExpect(MockMvcResultMatchers.jsonPath("$.body.todayGames[0].gameId").value(433))
                ...
                .andExpect(MockMvcResultMatchers.jsonPath("$.body.winPredictions[0].gameId").value(437))
                .andExpect(MockMvcResultMatchers.jsonPath("$.body.winPredictions[0].homeTeamId").value(3))
                .andExpect(MockMvcResultMatchers.jsonPath("$.body.winPredictions[0].awayTeamId").value(5))
                .andExpect(MockMvcResultMatchers.jsonPath("$.body.winPredictions[0].homeTeamName").value("키움 히어로즈"))
                .andExpect(MockMvcResultMatchers.jsonPath("$.body.winPredictions[0].awayTeamName").value("KIA 타이거즈"))
                .andExpect(MockMvcResultMatchers.jsonPath("$.body.winPredictions[0].homePitcherName").value("하영민"))
                .andExpect(MockMvcResultMatchers.jsonPath("$.body.winPredictions[0].awayPitcherName").value("김건국"))
                .andExpect(MockMvcResultMatchers.jsonPath("$.body.winPredictions[0].homePitcherProfileUrl").value("https://6ptotvmi5753.edge.naverncp.com/KBO_IMAGE/person/kbo/2025/64350.png"))
                .andExpect(MockMvcResultMatchers.jsonPath("$.body.winPredictions[0].awayPitcherProfileUrl").value("https://6ptotvmi5753.edge.naverncp.com/KBO_IMAGE/person/kbo/2025/76225.png"))
                .andExpect(MockMvcResultMatchers.jsonPath("$.body.winPredictions[0].homePredictionScore").value(3.5))
                .andExpect(MockMvcResultMatchers.jsonPath("$.body.winPredictions[0].awayPredictionScore").value(3.9))
                .andExpect(MockMvcResultMatchers.jsonPath("$.body.winPredictions[0].totalPredictionScore").value(7.4))
                .andExpect(MockMvcResultMatchers.jsonPath("$.body.winPredictions[0].homeWinPercent").value(47.6))
                .andExpect(MockMvcResultMatchers.jsonPath("$.body.winPredictions[0].awayWinPercent").value(52.4))
