...
public class HomeControllerTest extends MyRestDoc {
    ...
    void save_test() throws Exception {
        ...
        actions.andExpect(MockMvcResultMatchers.status().isOk())
                ...
                .andExpect(MockMvcResultMatchers.jsonPath("$.body.todayGames[0].homePitcherName").doesNotExist())
                .andExpect(MockMvcResultMatchers.jsonPath("$.body.todayGames[0].homeTeamLogoUrl").value("/img/logo/두산로고.png"))
                .andExpect(MockMvcResultMatchers.jsonPath("$.body.todayGames[0].awayPitcherName").doesNotExist())
                ...
                .andExpect(MockMvcResultMatchers.jsonPath("$.body.winPredictions[0].homePitcherName").doesNotExist())
                .andExpect(MockMvcResultMatchers.jsonPath("$.body.winPredictions[0].awayPitcherName").doesNotExist())
                .andExpect(MockMvcResultMatchers.jsonPath("$.body.winPredictions[0].homePitcherProfileUrl").doesNotExist())
                .andExpect(MockMvcResultMatchers.jsonPath("$.body.winPredictions[0].awayPitcherProfileUrl").doesNotExist())
