...
public class TodayGameControllerTest extends MyRestDoc {
    ...
    void get_today_game_predictions_test() throws Exception {
        ...
        actions.andExpect(MockMvcResultMatchers.status().isOk())
                ...
                // body[0]
                .andExpect(MockMvcResultMatchers.jsonPath("$.body[0].gameId").value(437))
                .andExpect(MockMvcResultMatchers.jsonPath("$.body[0].homeTeamId").value(3))
                .andExpect(MockMvcResultMatchers.jsonPath("$.body[0].awayTeamId").value(5))
                .andExpect(MockMvcResultMatchers.jsonPath("$.body[0].homeTeamName").value("키움 히어로즈"))
                .andExpect(MockMvcResultMatchers.jsonPath("$.body[0].awayTeamName").value("KIA 타이거즈"))
                .andExpect(MockMvcResultMatchers.jsonPath("$.body[0].homePitcherName").value("하영민"))
                .andExpect(MockMvcResultMatchers.jsonPath("$.body[0].awayPitcherName").value("김건국"))
                .andExpect(MockMvcResultMatchers.jsonPath("$.body[0].homePitcherProfileUrl").value("https://6ptotvmi5753.edge.naverncp.com/KBO_IMAGE/person/kbo/2025/64350.png"))
                .andExpect(MockMvcResultMatchers.jsonPath("$.body[0].awayPitcherProfileUrl").value("https://6ptotvmi5753.edge.naverncp.com/KBO_IMAGE/person/kbo/2025/76225.png"))
                .andExpect(MockMvcResultMatchers.jsonPath("$.body[0].homePredictionScore").value(3.5))
                .andExpect(MockMvcResultMatchers.jsonPath("$.body[0].awayPredictionScore").value(3.9))
                .andExpect(MockMvcResultMatchers.jsonPath("$.body[0].totalPredictionScore").value(7.4))
                .andExpect(MockMvcResultMatchers.jsonPath("$.body[0].homeWinPercent").value(47.6))
                .andExpect(MockMvcResultMatchers.jsonPath("$.body[0].awayWinPercent").value(52.4))

                // body[1]
                .andExpect(MockMvcResultMatchers.jsonPath("$.body[1].gameId").value(436))
                .andExpect(MockMvcResultMatchers.jsonPath("$.body[1].homeTeamId").value(10))
                .andExpect(MockMvcResultMatchers.jsonPath("$.body[1].awayTeamId").value(1))
                .andExpect(MockMvcResultMatchers.jsonPath("$.body[1].homeTeamName").value("KT 위즈"))
                .andExpect(MockMvcResultMatchers.jsonPath("$.body[1].awayTeamName").value("LG 트윈스"))
                .andExpect(MockMvcResultMatchers.jsonPath("$.body[1].homePitcherName").value("소형준"))
                .andExpect(MockMvcResultMatchers.jsonPath("$.body[1].awayPitcherName").value("임찬규"))
                .andExpect(MockMvcResultMatchers.jsonPath("$.body[1].homePitcherProfileUrl").value("https://6ptotvmi5753.edge.naverncp.com/KBO_IMAGE/person/kbo/2025/50030.png"))
                .andExpect(MockMvcResultMatchers.jsonPath("$.body[1].awayPitcherProfileUrl").value("https://6ptotvmi5753.edge.naverncp.com/KBO_IMAGE/person/kbo/2025/61101.png"))
                .andExpect(MockMvcResultMatchers.jsonPath("$.body[1].homePredictionScore").value(3.8))
                .andExpect(MockMvcResultMatchers.jsonPath("$.body[1].awayPredictionScore").value(3.8))
                .andExpect(MockMvcResultMatchers.jsonPath("$.body[1].totalPredictionScore").value(7.6))
                .andExpect(MockMvcResultMatchers.jsonPath("$.body[1].homeWinPercent").value(50.0))
                .andExpect(MockMvcResultMatchers.jsonPath("$.body[1].awayWinPercent").value(50.0))

                // body[2]
                .andExpect(MockMvcResultMatchers.jsonPath("$.body[2].gameId").value(435))
                .andExpect(MockMvcResultMatchers.jsonPath("$.body[2].homeTeamId").value(9))
                .andExpect(MockMvcResultMatchers.jsonPath("$.body[2].awayTeamId").value(7))
                ...
                // body[3]
                .andExpect(MockMvcResultMatchers.jsonPath("$.body[3].gameId").value(434))
                .andExpect(MockMvcResultMatchers.jsonPath("$.body[3].homeTeamId").value(6))
                .andExpect(MockMvcResultMatchers.jsonPath("$.body[3].awayTeamId").value(8))
                .andExpect(MockMvcResultMatchers.jsonPath("$.body[3].homeTeamName").value("삼성 라이온즈"))
                .andExpect(MockMvcResultMatchers.jsonPath("$.body[3].awayTeamName").value("한화 이글스"))
                .andExpect(MockMvcResultMatchers.jsonPath("$.body[3].homePitcherName").value("가라비토"))
                .andExpect(MockMvcResultMatchers.jsonPath("$.body[3].awayPitcherName").value("문동주"))
                .andExpect(MockMvcResultMatchers.jsonPath("$.body[3].homePitcherProfileUrl").value("https://6ptotvmi5753.edge.naverncp.com/KBO_IMAGE/person/kbo/2025/55460.png"))
                .andExpect(MockMvcResultMatchers.jsonPath("$.body[3].awayPitcherProfileUrl").value("https://6ptotvmi5753.edge.naverncp.com/KBO_IMAGE/person/kbo/2025/52701.png"))
                .andExpect(MockMvcResultMatchers.jsonPath("$.body[3].homePredictionScore").value(3.7))
                .andExpect(MockMvcResultMatchers.jsonPath("$.body[3].awayPredictionScore").value(3.8))
                .andExpect(MockMvcResultMatchers.jsonPath("$.body[3].totalPredictionScore").value(7.5))
                .andExpect(MockMvcResultMatchers.jsonPath("$.body[3].homeWinPercent").value(49.2))
                .andExpect(MockMvcResultMatchers.jsonPath("$.body[3].awayWinPercent").value(50.8))

                // body[4]
                .andExpect(MockMvcResultMatchers.jsonPath("$.body[4].gameId").value(433))
                .andExpect(MockMvcResultMatchers.jsonPath("$.body[4].homeTeamId").value(2))
                .andExpect(MockMvcResultMatchers.jsonPath("$.body[4].awayTeamId").value(4))
                .andExpect(MockMvcResultMatchers.jsonPath("$.body[4].homeTeamName").value("두산 베어스"))
                .andExpect(MockMvcResultMatchers.jsonPath("$.body[4].awayTeamName").value("SSG 랜더스"))
                .andExpect(MockMvcResultMatchers.jsonPath("$.body[4].homePitcherName").value("콜어빈"))
                .andExpect(MockMvcResultMatchers.jsonPath("$.body[4].awayPitcherName").value("김건우"))
                .andExpect(MockMvcResultMatchers.jsonPath("$.body[4].homePitcherProfileUrl").value("https://6ptotvmi5753.edge.naverncp.com/KBO_IMAGE/person/kbo/2025/55257.png"))
                .andExpect(MockMvcResultMatchers.jsonPath("$.body[4].awayPitcherProfileUrl").value("https://6ptotvmi5753.edge.naverncp.com/KBO_IMAGE/person/kbo/2025/51867.png"))
                .andExpect(MockMvcResultMatchers.jsonPath("$.body[4].homePredictionScore").value(4.2))
                .andExpect(MockMvcResultMatchers.jsonPath("$.body[4].awayPredictionScore").value(3.9))
                .andExpect(MockMvcResultMatchers.jsonPath("$.body[4].totalPredictionScore").value(8.1))
                .andExpect(MockMvcResultMatchers.jsonPath("$.body[4].homeWinPercent").value(52.0))
                .andExpect(MockMvcResultMatchers.jsonPath("$.body[4].awayWinPercent").value(48.0));
    ...
    void get_today_games_test() throws Exception {
        ...
        actions.andExpect(MockMvcResultMatchers.jsonPath("$.status").value(200))
                ...
                // Game 1
                .andExpect(MockMvcResultMatchers.jsonPath("$.body[0].gameId").value(433))
                ...
                // Game 2
                .andExpect(MockMvcResultMatchers.jsonPath("$.body[1].gameId").value(434))
                ...
                // Game 4
                .andExpect(MockMvcResultMatchers.jsonPath("$.body[3].gameId").value(436))
                ...
                // Game 5
                .andExpect(MockMvcResultMatchers.jsonPath("$.body[4].gameId").value(437))
