...
//        System.out.println(responseBody);
        ...
        actions.andExpect(MockMvcResultMatchers.status().isOk())
                ...
                .andExpect(MockMvcResultMatchers.jsonPath("$.body[0].homePitcherProfileUrl").exists())
                .andExpect(MockMvcResultMatchers.jsonPath("$.body[0].awayPitcherProfileUrl").exists())
                ...
                .andExpect(MockMvcResultMatchers.jsonPath("$.body[1].homePitcherProfileUrl").exists())
                .andExpect(MockMvcResultMatchers.jsonPath("$.body[1].awayPitcherProfileUrl").exists())
                ...
                .andExpect(MockMvcResultMatchers.jsonPath("$.body[2].homePitcherProfileUrl").exists())
                .andExpect(MockMvcResultMatchers.jsonPath("$.body[2].awayPitcherProfileUrl").exists())
                ...
                .andExpect(MockMvcResultMatchers.jsonPath("$.body[3].homePitcherProfileUrl").exists())
                .andExpect(MockMvcResultMatchers.jsonPath("$.body[3].awayPitcherProfileUrl").exists())
                ...
                .andExpect(MockMvcResultMatchers.jsonPath("$.body[4].homePitcherProfileUrl").exists())
                .andExpect(MockMvcResultMatchers.jsonPath("$.body[4].awayPitcherProfileUrl").exists())
