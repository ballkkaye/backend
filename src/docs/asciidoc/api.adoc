...
=== 1. 상대전적
===== Request Example
include::{snippets}/{todayHitterLineup}/getMatchupDetails_test/http-request.adoc[]

===== Response Example
include::{snippets}/{todayHitterLineup}/getMatchupDetails_test/http-response.adoc[]
