...
public class TodayStartingPitcher {
    ...
    @Builder
    public TodayStartingPitcher(Integer id, Game game, Player player, String profileUrl, Double ERA, Integer gameCount, String result, Integer QS, Double WHIP, Timestamp createdAt) {
        this.id = id;
        this.game = game;
        this.player = player;
