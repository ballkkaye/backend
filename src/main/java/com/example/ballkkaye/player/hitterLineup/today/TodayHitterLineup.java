...
public class TodayHitterLineup {
    ...
    @Builder
    public TodayHitterLineup(Game game, Team team, Player player, Integer todayHitterOrder, String position, Integer ab, Integer h, Double avg, Double seasonAvg, Double ops) {
        this.game = game;
        this.team = team;
        this.player = player;
