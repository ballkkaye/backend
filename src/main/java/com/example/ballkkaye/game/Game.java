...
public class Game {
    ...
    @Builder
    public Game(Integer id, Stadium stadium, Team awayTeam, Team homeTeam, GameStatus gameStatus, Timestamp gameTime, Integer homeResultScore, Integer awayResultScore, BroadcastChannel broadcastChannel, Double homePredictionScore, Double awayPredictionScore, Double totalPredictionScore, Double homeWinPer, Double awayWinPer, Timestamp createdAt) {
        this.id = id;
