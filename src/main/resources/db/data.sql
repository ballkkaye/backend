...
VALUES
-- 두산 vs SSG
(1, TIMESTAMP '2025-07-15 18:30:00', 1, 'MS_T', 'SCHEDULED', 2, 4,
 52.0, 48.0, 4.2, 3.9, 3, 5, 8.1, 423),

-- 삼성 vs 한화
(2, TIMESTAMP '2025-07-15 18:30:00', 5, 'KN_T', 'SCHEDULED', 6, 8,
 49.2, 50.8, 3.7, 3.8, 3, 5, 7.5, 424),

-- NC vs 롯데
(3, TIMESTAMP '2025-07-15 18:30:00', 8, 'SS_T', 'SCHEDULED', 9, 7,
 55.6, 44.4, 4.5, 3.6, 3, 5, 8.1, 425),

-- KT vs LG
(4, TIMESTAMP '2025-07-15 18:30:00', 9, 'SPO_T', 'SCHEDULED', 10, 1,
 50.0, 50.0, 3.8, 3.8, 5, 5, 7.6, 426),

-- 키움 vs KIA
(5, TIMESTAMP '2025-07-15 18:30:00', 2, 'SPO_2T', 'SCHEDULED', 3, 5,
 47.6, 52.4, 3.5, 3.9, 2, 0, 7.4, 427),

------------------------------------
-- 두산 vs SSG
(6, TIMESTAMP '2025-07-16 18:30:00', 1, 'MS_T', 'SCHEDULED', 2, 4,
 52.0, 48.0, 4.2, 3.9, 3, 5, 8.1, 433),

-- 삼성 vs 한화
(7, TIMESTAMP '2025-07-16 18:30:00', 5, 'KN_T', 'SCHEDULED', 6, 8,
 49.2, 50.8, 3.7, 3.8, 3, 5, 7.5, 434),

-- NC vs 롯데
(8, TIMESTAMP '2025-07-16 18:30:00', 8, 'SS_T', 'SCHEDULED', 9, 7,
 55.6, 44.4, 4.5, 3.6, 3, 5, 8.1, 435),

-- KT vs LG
(9, TIMESTAMP '2025-07-16 18:30:00', 9, 'SPO_T', 'SCHEDULED', 10, 1,
...
VALUES (437, 95.0, 0.0, 0.0, 2, 24.0, 1.0, CURRENT_TIMESTAMP, TIMESTAMP '2025-07-15 06:00:00', 'DB01', 'SOUTH_EAST'),
       (437, 90.0, 0.0, 0.0, 2, 26.0, 1.0, CURRENT_TIMESTAMP, TIMESTAMP '2025-07-15 07:00:00', 'DB01', 'SOUTH'),
       (437, 85.0, 0.0, 0.0, 2, 27.0, 1.2, CURRENT_TIMESTAMP, TIMESTAMP '2025-07-15 08:00:00', 'DB01', 'SOUTH_WEST'),
       (437, 80.0, 0.0, 0.0, 2, 28.0, 1.4, CURRENT_TIMESTAMP, TIMESTAMP '2025-07-15 09:00:00', 'DB01', 'WEST'),
       (437, 75.0, 0.0, 20.0, 2, 29.0, 1.9, CURRENT_TIMESTAMP, TIMESTAMP '2025-07-15 10:00:00', 'DB01', 'NORTH_WEST'),
       (437, 65.0, 0.0, 20.0, 2, 30.0, 2.1, CURRENT_TIMESTAMP, TIMESTAMP '2025-07-15 11:00:00', 'DB01', 'NORTH_WEST'),
       (437, 65.0, 0.0, 30.0, 2, 32.0, 2.5, CURRENT_TIMESTAMP, TIMESTAMP '2025-07-15 12:00:00', 'DB01', 'NORTH_WEST'),
       (437, 60.0, 0.0, 30.0, 2, 33.0, 2.6, CURRENT_TIMESTAMP, TIMESTAMP '2025-07-15 13:00:00', 'DB01', 'NORTH_WEST'),
       (437, 55.0, 0.0, 20.0, 2, 34.0, 2.7, CURRENT_TIMESTAMP, TIMESTAMP '2025-07-15 14:00:00', 'DB01', 'NORTH_WEST'),
       (437, 60.0, 0.0, 0.0, 2, 33.0, 3.1, CURRENT_TIMESTAMP, TIMESTAMP '2025-07-15 15:00:00', 'DB01', 'NORTH_WEST'),
       (437, 60.0, 0.0, 0.0, 2, 33.0, 3.4, CURRENT_TIMESTAMP, TIMESTAMP '2025-07-15 16:00:00', 'DB01', 'NORTH_WEST'),
       (437, 70.0, 0.0, 20.0, 2, 32.0, 3.5, CURRENT_TIMESTAMP, TIMESTAMP '2025-07-15 17:00:00', 'DB01', 'NORTH_WEST'),
       (437, 75.0, 0.0, 30.0, 2, 31.0, 3.0, CURRENT_TIMESTAMP, TIMESTAMP '2025-07-15 18:00:00', 'DB01', 'NORTH_WEST'),
       (437, 80.0, 0.0, 0.0, 2, 28.0, 1.9, CURRENT_TIMESTAMP, TIMESTAMP '2025-07-15 19:00:00', 'DB01', 'NORTH_WEST'),
       (437, 80.0, 0.0, 20.0, 2, 27.0, 1.3, CURRENT_TIMESTAMP, TIMESTAMP '2025-07-15 20:00:00', 'DB01', 'NORTH_WEST'),
       (437, 85.0, 0.0, 30.0, 2, 26.0, 1.1, CURRENT_TIMESTAMP, TIMESTAMP '2025-07-15 21:00:00', 'DB01', 'NORTH'),
       (437, 90.0, 0.0, 30.0, 2, 26.0, 0.8, CURRENT_TIMESTAMP, TIMESTAMP '2025-07-15 22:00:00', 'DB01', 'NORTH'),
       (437, 90.0, 0.0, 30.0, 2, 25.0, 0.6, CURRENT_TIMESTAMP, TIMESTAMP '2025-07-15 23:00:00', 'DB01', 'NORTH'),
