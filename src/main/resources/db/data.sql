...
VALUES (418, TIMESTAMP '2025-07-13 18:30:00', 1, 'MS_T', 'SCHEDULED', 2, 4, 50.0, 50.0, NULL, NULL, 6, 5, NULL),
       ...
       (423, TIMESTAMP '2025-07-14 18:30:00', 1, 'MS_T', 'SCHEDULED', 2, 4, 50.0, 50.0, NULL, NULL, 3, 5, NULL),
       (424, TIMESTAMP '2025-07-14 18:30:00', 5, 'KN_T', 'SCHEDULED', 6, 8, 50.0, 50.0, NULL, NULL, 3, 5, NULL),
       (425, TIMESTAMP '2025-07-14 18:30:00', 8, 'SS_T', 'SCHEDULED', 9, 7, 50.0, 50.0, NULL, NULL, 3, 5, NULL),
       (426, TIMESTAMP '2025-07-14 18:30:00', 9, 'SPO_T', 'SCHEDULED', 10, 1, 50.0, 50.0, NULL, NULL, 5, 5, NULL),
       (427, TIMESTAMP '2025-07-14 18:30:00', 2, 'SPO_2T', 'SCHEDULED', 3, 5, 50.0, 50.0, NULL, NULL, 2, 0, NULL),
       (428, TIMESTAMP '2025-07-15 18:30:00', 1, 'MS_T', 'SCHEDULED', 2, 4, 50.0, 50.0, NULL, NULL, 3, 5, NULL),
       (429, TIMESTAMP '2025-07-15 18:30:00', 5, 'KN_T', 'SCHEDULED', 6, 8, 50.0, 50.0, NULL, NULL, 3, 5, NULL),
       (430, TIMESTAMP '2025-07-15 18:30:00', 8, 'SS_T', 'SCHEDULED', 9, 7, 50.0, 50.0, NULL, NULL, 3, 5, NULL),
       (431, TIMESTAMP '2025-07-15 18:30:00', 9, 'SPO_T', 'SCHEDULED', 10, 1, 50.0, 50.0, NULL, NULL, 5, 5, NULL),
       (432, TIMESTAMP '2025-07-15 18:30:00', 2, 'SPO_2T', 'SCHEDULED', 3, 5, 50.0, 50.0, NULL, NULL, 2, 0, NULL),
       (433, TIMESTAMP '2025-07-16 18:30:00', 1, 'MS_T', 'SCHEDULED', 2, 4, 50.0, 50.0, NULL, NULL, 3, 5, NULL),
       (434, TIMESTAMP '2025-07-16 18:30:00', 5, 'KN_T', 'SCHEDULED', 6, 8, 50.0, 50.0, NULL, NULL, 2, 3, NULL),
       (435, TIMESTAMP '2025-07-16 18:30:00', 8, 'SS_T', 'SCHEDULED', 9, 7, 50.0, 50.0, NULL, NULL, 4, 4, NULL),
       (436, TIMESTAMP '2025-07-16 18:30:00', 9, 'SPO_T', 'SCHEDULED', 10, 1, 50.0, 50.0, NULL, NULL, 6, 7, NULL),
       (437, TIMESTAMP '2025-07-16 18:30:00', 2, 'SPO_2T', 'SCHEDULED', 3, 5, 50.0, 50.0, NULL, NULL, 3, 2, NULL),
...
VALUES
-- 두산 vs SSG
(1, TIMESTAMP '2025-07-14 18:30:00', 1, 'MS_T', 'SCHEDULED', 2, 4,
 52.0, 48.0, 4.2, 3.9, 3, 5, 8.1, 423),

-- 삼성 vs 한화
(2, TIMESTAMP '2025-07-14 18:30:00', 5, 'KN_T', 'SCHEDULED', 6, 8,
 49.2, 50.8, 3.7, 3.8, 3, 5, 7.5, 424),

-- NC vs 롯데
(3, TIMESTAMP '2025-07-14 18:30:00', 8, 'SS_T', 'SCHEDULED', 9, 7,
 55.6, 44.4, 4.5, 3.6, 3, 5, 8.1, 425),

-- KT vs LG
(4, TIMESTAMP '2025-07-14 18:30:00', 9, 'SPO_T', 'SCHEDULED', 10, 1,
 50.0, 50.0, 3.8, 3.8, 5, 5, 7.6, 426),

-- 키움 vs KIA
(5, TIMESTAMP '2025-07-14 18:30:00', 2, 'SPO_2T', 'SCHEDULED', 3, 5,
...
VALUES (423, 3, 29, 1, '1루수', 3, 1, 0.333, 0.285, 0.821, CURRENT_TIMESTAMP),
       (423, 3, 30, 2, '2루수', 4, 2, 0.500, 0.312, 0.920, CURRENT_TIMESTAMP),
       (423, 3, 31, 3, '3루수', 2, 1, 0.500, 0.298, 0.850, CURRENT_TIMESTAMP),
       (423, 3, 32, 4, '유격수', 3, 0, 0.000, 0.245, 0.650, CURRENT_TIMESTAMP),
       (423, 3, 33, 5, '좌익수', 3, 2, 0.667, 0.320, 0.940, CURRENT_TIMESTAMP),
       (423, 3, 34, 6, '중견수', 4, 1, 0.250, 0.278, 0.770, CURRENT_TIMESTAMP),
       (423, 3, 35, 7, '우익수', 2, 1, 0.500, 0.299, 0.865, CURRENT_TIMESTAMP),
       (423, 3, 36, 8, '포수', 3, 1, 0.333, 0.260, 0.745, CURRENT_TIMESTAMP),
       (423, 3, 37, 9, '지명타자', 3, 0, 0.000, 0.240, 0.680, CURRENT_TIMESTAMP),
...
VALUES (437, 95.0, 0.0, 0.0, 2, 24.0, 1.0, CURRENT_TIMESTAMP, TIMESTAMP '2025-07-14 06:00:00', 'DB01', 'SOUTH_EAST'),
       (437, 90.0, 0.0, 0.0, 2, 26.0, 1.0, CURRENT_TIMESTAMP, TIMESTAMP '2025-07-14 07:00:00', 'DB01', 'SOUTH'),
       (437, 85.0, 0.0, 0.0, 2, 27.0, 1.2, CURRENT_TIMESTAMP, TIMESTAMP '2025-07-14 08:00:00', 'DB01', 'SOUTH_WEST'),
       (437, 80.0, 0.0, 0.0, 2, 28.0, 1.4, CURRENT_TIMESTAMP, TIMESTAMP '2025-07-14 09:00:00', 'DB01', 'WEST'),
       (437, 75.0, 0.0, 20.0, 2, 29.0, 1.9, CURRENT_TIMESTAMP, TIMESTAMP '2025-07-14 10:00:00', 'DB01', 'NORTH_WEST'),
       (437, 65.0, 0.0, 20.0, 2, 30.0, 2.1, CURRENT_TIMESTAMP, TIMESTAMP '2025-07-14 11:00:00', 'DB01', 'NORTH_WEST'),
       (437, 65.0, 0.0, 30.0, 2, 32.0, 2.5, CURRENT_TIMESTAMP, TIMESTAMP '2025-07-14 12:00:00', 'DB01', 'NORTH_WEST'),
       (437, 60.0, 0.0, 30.0, 2, 33.0, 2.6, CURRENT_TIMESTAMP, TIMESTAMP '2025-07-14 13:00:00', 'DB01', 'NORTH_WEST'),
       (437, 55.0, 0.0, 20.0, 2, 34.0, 2.7, CURRENT_TIMESTAMP, TIMESTAMP '2025-07-14 14:00:00', 'DB01', 'NORTH_WEST'),
       (437, 60.0, 0.0, 0.0, 2, 33.0, 3.1, CURRENT_TIMESTAMP, TIMESTAMP '2025-07-14 15:00:00', 'DB01', 'NORTH_WEST'),
       (437, 60.0, 0.0, 0.0, 2, 33.0, 3.4, CURRENT_TIMESTAMP, TIMESTAMP '2025-07-14 16:00:00', 'DB01', 'NORTH_WEST'),
       (437, 70.0, 0.0, 20.0, 2, 32.0, 3.5, CURRENT_TIMESTAMP, TIMESTAMP '2025-07-14 17:00:00', 'DB01', 'NORTH_WEST'),
       (437, 75.0, 0.0, 30.0, 2, 31.0, 3.0, CURRENT_TIMESTAMP, TIMESTAMP '2025-07-14 18:00:00', 'DB01', 'NORTH_WEST'),
       (437, 80.0, 0.0, 0.0, 2, 28.0, 1.9, CURRENT_TIMESTAMP, TIMESTAMP '2025-07-14 19:00:00', 'DB01', 'NORTH_WEST'),
       (437, 80.0, 0.0, 20.0, 2, 27.0, 1.3, CURRENT_TIMESTAMP, TIMESTAMP '2025-07-14 20:00:00', 'DB01', 'NORTH_WEST'),
       (437, 85.0, 0.0, 30.0, 2, 26.0, 1.1, CURRENT_TIMESTAMP, TIMESTAMP '2025-07-14 21:00:00', 'DB01', 'NORTH'),
       (437, 90.0, 0.0, 30.0, 2, 26.0, 0.8, CURRENT_TIMESTAMP, TIMESTAMP '2025-07-14 22:00:00', 'DB01', 'NORTH'),
       (437, 90.0, 0.0, 30.0, 2, 25.0, 0.6, CURRENT_TIMESTAMP, TIMESTAMP '2025-07-14 23:00:00', 'DB01', 'NORTH'),
